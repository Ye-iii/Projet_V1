...
public class Main {
    public static void main(String[] args) {
        Passager passager = new Passager("0789", "Jean", "Nantes", "07xxxxxxxx", "AB123456");
        Pilote pilote = new Pilote("0456", "Marie", "Lyon", "06xxxxxxxx", "EMP001", "2020-01-01", "Licence123", "5000");
        PersonnelCabine personnel = new PersonnelCabine("0123", "Paul", "Paris", "07xxxxxxxx", "EM002", "02/07/2022", "Qualifié");
